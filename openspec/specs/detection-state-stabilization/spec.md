# Capability: Detection State Stabilization

## Purpose

Stabilize camera-side detection state transitions so readiness UI remains consistent during continuous scanning.
