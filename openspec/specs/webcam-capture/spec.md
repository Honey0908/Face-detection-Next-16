# Capability: Webcam Capture

## Purpose

Browser webcam access via `navigator.mediaDevices.getUserMedia()` with permission handling, video stream management, frame capture for face detection, and camera status monitoring. Used by both registration and scan workflows.
