# Capability: Face Matching

## Purpose

Euclidean distance-based face matching against registered user descriptors. Implements configurable threshold (default 0.6), best-match selection, in-memory caching, confidence reporting, and structured result responses.
