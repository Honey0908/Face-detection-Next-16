...
Real-time face detection from webcam video streams using TinyFaceDetector. Provides bounding boxes, confidence scores, single-face validation, and detection state management for registration and scanning workflows.
